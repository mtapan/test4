...
import static com.dev.challenge.dao.constants.Constants.LATITUDE_KEY;
import static com.dev.challenge.dao.constants.Constants.LONGITUDE_KEY;
	...
	public Map<String, String> getCoordinatesByAddress(final String address) throws RuntimeException {
		...
		try {
			...
			for (Results res : results) {
				coordinateMap.put(LATITUDE_KEY, Double.toString(res.getGeometry().getLocation().getLat()));
				coordinateMap.put(LONGITUDE_KEY, Double.toString(res.getGeometry().getLocation().getLng()));
			}
